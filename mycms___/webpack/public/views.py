...
from mycms.admin.models import Module, SlideShowImage, HomeText, Logo, TechnologiesImage, TechnologiesText, CopyRight, FooterText, SocialMediaIcon, FooterImage, CopyRight
...
def home():
    ...
    return render_template("public/home.html", form=form, footer_image=footer_image, icons=media_icons, footer_text=footer_text, slideshows=slideshows, home_title=hometext, logo=logo, techno_img=techno_img, text_techno=text_techno, copyright_text=copyright_text)
...
def login():
    ...
    return render_template("public/login.html", form=form, logo=logo, footer_text=footer_text, footer_image=footer_image, icons=media_icons, copyright_text=copyright_text)
...
def register():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for("public.home"))
    return render_template("public/register.html", form=form, logo = Logo.query.first(), footer_text=footer_text, footer_image=footer_image, icons=media_icons, copyright_text=copyright_text)
...
def about():
    ...
    footer_image = FooterImage.query.first()
    copyright_text = CopyRight.query.first()
    return render_template("public/about.html", form=form, logo = Logo.query.first(), footer_text=footer_text, footer_image=footer_image, icons=media_icons, copyright_text=copyright_text)
