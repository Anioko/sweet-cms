...
def account():
	...
	return render_template('client/account.html', form=form)
...
def brand():
	...
	return render_template('client/brand.html', form=form, brand=brand)
...
def download():
	...
	return render_template('client/download.html', generated_files=generated_files)
